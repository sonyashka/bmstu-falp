\begin{titlepage}
	...
	\begin{center}
		...
		\Large\textbf{\textsc{ПО ЛАБОРАТОРНОЙ РАБОТЕ №11}}\\
	\end{center}
	
	\vspace{1cm}
	
	\noindent\textnormal{Название:} \hspace{15mm} \underline{\textnormal{~Среда Visual Prolog 5.2. Структура программы на Prolog~}}\noindent
